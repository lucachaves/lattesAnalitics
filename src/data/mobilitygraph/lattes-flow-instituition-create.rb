...
@latitude_continent = {}
@latitude_continent["america do norte"] = {latitude: 48.1667, longitude: -100.1667, acronym: 'AMN'}
@latitude_continent["america central"] = {latitude: 17.4, longitude: -91.0, acronym: 'AMC'}
@latitude_continent["america do sul"] = {latitude: -13.0, longitude: -59.4, acronym: 'AMS'}
@latitude_continent["europa"] = {latitude: 54.9, longitude: 25.3167, acronym: 'EU'}
@latitude_continent["africa"] = {latitude: 7.1881, longitude: 21.0936, acronym: 'AF'}
@latitude_continent["oceania"] = {latitude: -30.0, longitude: 140.0, acronym: 'OC'}
@latitude_continent["asia"] = {latitude: 46.283, longitude: 86.67, acronym: 'AS'}
...
@latitude_region = {}
@latitude_region["norte"] = {latitude: -4.603292, longitude: -59.199124, acronym: 'N'}
@latitude_region["nordeste"] = {latitude: -8.624365, longitude: -41.742753, acronym: 'NE'}
@latitude_region["centro-oeste"] = {latitude: -15.298172, longitude: -54.305408, acronym: 'CO'}
@latitude_region["sudeste"] = {latitude: -19.730012, longitude: -45.483580, acronym: 'SE'}
@latitude_region["sul"] = {latitude: -27.542207, longitude: -52.252997, acronym: 'S'}
...
@latitude_state = {}
@latitude_state["acre"] = {latitude: -9.11, longitude: -70.52, region: "norte", acronym: 'AC'}
@latitude_state["roraima"] = {latitude: 2.05, longitude: -61.4, region: "norte", acronym: 'RR'}
@latitude_state["rondonia"] = {latitude: -10.9, longitude: -62.76, region: "norte", acronym: 'RO'}
@latitude_state["amapa"] = {latitude: 1, longitude: -52, region: "norte", acronym: 'AP'}
@latitude_state["amazonas"] = {latitude: -5, longitude: -63, region: "norte", acronym: 'AM'}
@latitude_state["para"] = {latitude: -5.666667, longitude: -52.733333, region: "norte", acronym: 'PA'}
@latitude_state["tocantins"] = {latitude: -10.183333, longitude: -48.333333, region: "norte", acronym: 'TO'}
@latitude_state["alagoas"] = {latitude: -9.57, longitude: -36.55, region: "nordeste", acronym: 'AL'}
@latitude_state["bahia"] = {latitude: -12.52, longitude: -41.69, region: "nordeste", acronym: 'BA'}
@latitude_state["ceara"] = {latitude: -5.08, longitude: -39.65, region: "nordeste", acronym: 'CE'}
@latitude_state["maranhao"] = {latitude: -6.183333, longitude: -45.616667, region: "nordeste", acronym: 'MA'}
@latitude_state["paraiba"] = {latitude: -7.166667, longitude: -36.833333, region: "nordeste", acronym: 'PB'}
@latitude_state["pernambuco"] = {latitude: -8.34, longitude: -37.81, region: "nordeste", acronym: 'PE'}
@latitude_state["rio grande do norte"] = {latitude: -5.74, longitude: -36.55, region: "nordeste", acronym: 'RN'}
@latitude_state["sergipe"] = {latitude: -10.59, longitude: -37.38, region: "nordeste", acronym: 'SE'}
...
@latitude_state["rio de janeiro"] = {latitude: -22.9, longitude: -43.2, region: "sudeste", acronym: 'RJ'}
@latitude_state["sao paulo"] = {latitude: -23.533333, longitude: -46.633333, region: "sudeste", acronym: 'SP'}
@latitude_state["parana"] = {latitude: -24, longitude: -51, region: "sul", acronym: 'PR'}
@latitude_state["rio grande do sul"] = {latitude: -30, longitude: -53, region: "sul", acronym: 'RS'}
@latitude_state["santa catarina"] = {latitude: -27.25, longitude: -50.333333, region: "sul", acronym: 'SC'}
...
@latitude_continent.each{|name,value|
	countNode += 1
	places_extra << [countNode,name,value[:acronym],"continent",value[:latitude],value[:longitude],nil]
	places_key[name] = countNode
}

@latitude_country.each{|name,value|
	countNode += 1
	places_extra << [countNode,name,name,"country",value[:latitude],value[:longitude],places_key[value[:continent]]]
	places_key[name] = countNode
}

@latitude_region.each{|name,value|
	countNode += 1
	places_extra << [countNode,name,value[:acronym],"region",value[:latitude],value[:longitude],places_key['brazil']]
	places_key[name] = countNode
}

@latitude_state.each{|name,value|
	countNode += 1
	places_extra << [countNode,name,value[:acronym],"state",value[:latitude],value[:longitude],places_key[value[:region]]]
	places_key[name] = countNode
}
...
cities_key = {}
puts "Iniciar"
# "id";"id16";"kind";"place";"place_ascii";"place_abbr";"start_year";"end_year";"city";"city_ascii";"state";"country";"country_ascii";"country_abbr";"latitude";"longitude"
...
csv_string = CSV.generate(:col_sep => ",") do |csv|
	csv << ["id", "name", "acronym", "kind", "latitude", "longitude", "belong_to"]
	...
	places.each{|index,place|
		if place[:class] == "city"
			if place[:country] == "brazil"
				csv << [place[:id],place[:place],place[:place],place[:class],place[:latitude],place[:longitude],places_key[place[:state]]]
			else
				csv << [place[:id],place[:place],place[:place],place[:class],place[:latitude],place[:longitude],places_key[place[:country]]]
			end
		else
			if(!cities_key.has_key?("#{place[:latitude]},#{place[:longitude]}"))
				countNode += 1
				if place[:country] == "brazil"
					csv << [countNode,place[:city],place[:place],"city",place[:latitude],place[:longitude],places_key[place[:state]]]
				else
					csv << [countNode,place[:city],place[:place],"city",place[:latitude],place[:longitude],places_key[place[:country]]]
				end
				cities_key["#{place[:latitude]},#{place[:longitude]}"] = countNode
			end
			csv << [place[:id],place[:place],place[:place],place[:class],nil,nil,cities_key["#{place[:latitude]},#{place[:longitude]}"]]
		end
	}
...
edges.each{|edge|
	...
	source_id = if kind == "birth"
		...
		edge[:source][4]+edge[:source][14]+edge[:source][15]
	end

	target_id = edge[:target][4]+edge[:target][14]+edge[:target][15]
	...
	network << [id16, kind, source, target, start_year, end_year]
}

csv_string = CSV.generate(:col_sep => ",") do |csv|
	csv << ["id", "id16", "kind", "source", "target", "start_year", "end_year"]
	count = 0
	network.each{|edge|
		count += 1
		csv << [count]+edge
